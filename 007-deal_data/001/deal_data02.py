...
def extract_fields(row):
    try:
        ...
        return {
            ...
            "ingest_timestamp": data["payload"]["ingest_timestamp"],
        }
...
# # 转换 'timestamp' 和 'ingest_timestamp' 列为时间格式
# df_sorted['timestamp'] = pd.to_datetime(df_sorted['timestamp'], unit='ms')
# df_sorted['ingest_timestamp'] = pd.to_datetime(df_sorted['ingest_timestamp'], unit='ms')
