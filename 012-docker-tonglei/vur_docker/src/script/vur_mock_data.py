...
class DataGenerator(object):
    ...
    def generate_data(self):
        ...
        if indicator['name'] == "EML_GeschwX_XIX_EML_06_XIX_E3V_FASCANFD1":
            # 1.1 横向加速度
            ...
            # print(indicator_acceleration['name'])
            ...
            data_acceleration = {
                ...
                "payload": {
                    "mdc_id": 180940,
                    "g_id": 1,
                    "name": indicator_acceleration['name'],  # 指标名称
                    "value": indicator_acceleration['value'],  # 值
                    "unit": indicator_acceleration['unit'],  # 单位
                    "timestamp": timestamp,
                    "containerMsgId": 4,
            ...
            data_li.append(data_acceleration)
