...
INDICATORS_DBR = [
    # 1.1 横向加速度
    {
        ...
        "value": round(random.uniform(-20.45, 20.45), 2),
        "unit": "m/s*2"
    },
    # 1.2 纵向加速度
    {
    ...
    # 1.3 速度
    {
        ...
        "value": round(random.uniform(0, 127.8125), 2),
        "unit": "m/s"
    },
    # =========================
    # 2.1 转向角度
    ...
    # 6.3 开始充电
    {
        ...
        "value": random.choice([4, 6]),  # 4= AC Charing ; 6= DC Charging
        "unit": ""
    },
]
...
# 2. 第二批指标
INDICATORS_VHR = [
    # 冷却液   ---另一个信号 BCM_Kuehlmittel_Sensor_02_XIX_BCM_01_XIX_E3V_KCAN
    {
...
class DataGenerator:
    ...
    def __init__(self, bootstrap_servers='39.107.107.149:9092', topic='test'):
    ...
    def generate_data(self):
        ...
        indicator = random.choice(INDICATORS_DBR)
        print(indicator)
